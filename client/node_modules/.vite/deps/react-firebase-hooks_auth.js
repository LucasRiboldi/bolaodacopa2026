...
import { $ as onAuthStateChanged, At as verifyBeforeUpdateEmail, C as TwitterAuthProvider, Dt as updateProfile, N as createUserWithEmailAndPassword, Tt as updatePassword, _t as signInWithEmailLink, dt as sendSignInLinkToEmail, et as onIdTokenChanged, f as OAuthProvider, gt as signInWithEmailAndPassword, l as GithubAuthProvider, lt as sendEmailVerification, s as FacebookAuthProvider, u as GoogleAuthProvider, ut as sendPasswordResetEmail, wt as updateEmail, yt as signInWithPopup } from "./index.esm-CM_ijRG4.js";
//#region node_modules/react-firebase-hooks/auth/dist/index.esm.js
...
var reducer = function() {
	return function(state, action) {
		switch (action.type) {
			...
			case "reset": return defaultState(action.defaultValue);
			case "value": return __assign(__assign({}, state), {
				error: void 0,
				loading: false,
				value: action.value
			});
...
var useLoadingValue = (function(getDefaultValue) {
	...
	var reset = (0, import_react.useCallback)(function() {
		dispatch({
			type: "reset",
			defaultValue: getDefaultValue ? getDefaultValue() : void 0
		});
	}, [getDefaultValue]);
...
var useCreateUserWithEmailAndPassword = (function(auth, options) {
	...
	return [
		(0, import_react.useCallback)(function(email, password) {
			return __awaiter(void 0, void 0, void 0, function() {
				var user, error_1;
				return __generator(this, function(_a) {
					switch (_a.label) {
...
var useSendPasswordResetEmail = (function(auth) {
	...
	var _b = (0, import_react.useState)(false), loading = _b[0], setLoading = _b[1];
	return [
		(0, import_react.useCallback)(function(email, actionCodeSettings) {
			return __awaiter(void 0, void 0, void 0, function() {
				var err_1;
				return __generator(this, function(_a) {
					switch (_a.label) {
...
var useSignInWithEmailLink = (function(auth) {
	...
	var _c = (0, import_react.useState)(false), loading = _c[0], setLoading = _c[1];
	return [
		(0, import_react.useCallback)(function(email, emailLink) {
			return __awaiter(void 0, void 0, void 0, function() {
				var user, err_1;
				return __generator(this, function(_a) {
					switch (_a.label) {
...
var useSignInWithFacebook = function(auth) {
	return useSignInWithPopup(auth, (0, import_react.useCallback)(function(scopes, customOAuthParameters) {
		var provider = new FacebookAuthProvider();
		if (scopes) scopes.forEach(function(scope) {
...
var useSignInWithPopup = function(auth, createProvider) {
	...
	var _c = (0, import_react.useState)(false), loading = _c[0], setLoading = _c[1];
	return [
		(0, import_react.useCallback)(function(scopes, customOAuthParameters) {
			return __awaiter(void 0, void 0, void 0, function() {
...
var useUpdateEmail = function(auth) {
	...
	var _b = (0, import_react.useState)(false), loading = _b[0], setLoading = _b[1];
	return [
		(0, import_react.useCallback)(function(email) {
			return __awaiter(void 0, void 0, void 0, function() {
				var err_1;
				return __generator(this, function(_a) {
					switch (_a.label) {
...
var useUpdatePassword = function(auth) {
	...
	var _b = (0, import_react.useState)(false), loading = _b[0], setLoading = _b[1];
	return [
		(0, import_react.useCallback)(function(password) {
			return __awaiter(void 0, void 0, void 0, function() {
				var err_2;
				return __generator(this, function(_a) {
					switch (_a.label) {
...
var useUpdateProfile = function(auth) {
	...
	var _b = (0, import_react.useState)(false), loading = _b[0], setLoading = _b[1];
	return [
		(0, import_react.useCallback)(function(profile) {
			return __awaiter(void 0, void 0, void 0, function() {
				var err_3;
				return __generator(this, function(_a) {
					switch (_a.label) {
